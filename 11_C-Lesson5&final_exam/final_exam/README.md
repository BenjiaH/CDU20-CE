...
- 注意事项：
  - 1.本次考核共有两个大题，任选其一即可；
  - 2.请将考核提交作品放入文件夹并压缩成“ .zip”文件，文件夹与压缩文件均命名为“学号_姓名_题目”。例如：“202010428301_张三_1.zip”；
  - 3.请在截止日期前将压缩包提交给科技委员；
  - 4.若选题为“PCB电路设计”
    - a.请将工程文件夹中的“History”文件夹删除；
    - b.原理图请查看“\PCB_Design\STC89C52_core_board\STC89C52_core_board.- pdf”文件；
    - c.集成库文件位与- “\PCB_Design\STC89C52_core_board\STC89C52_core_board.     IntLib”
    - d.严禁使用自动布线。
